...
RUN java_version=7u79; \
    ...
    && echo 'Downloading grouper Voot Connector...'\
    && wget -q http://software.internet2.edu/grouper/release/2.2.1/grouper.vootBinary-2.2.1.tar.gz \
    ...
    && tar -zxf grouper.vootBinary-2.2.1.tar.gz -C /opt \

    && rm grouper.apiBinary-2.2.1.tar.gz grouper.ui-2.2.1.tar.gz grouper.ws-2.2.1.tar.gz grouper.psp-2.2.1.tar.gz grouper.clientBinary-2.2.1.tar.gz grouper.vootBinary-2.2.1.tar.gz
